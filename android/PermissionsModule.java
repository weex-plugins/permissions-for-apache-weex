 ...
 */
package com.taobao.weex.extend.module.permissions;
...
/**
 * Created by moxun on 16/11/21.
 */

public class PermissionsModule extends WXSDKEngine.DestroyableModule {
    ...
    @JSMethod
    public void requestPermission(final String permission, Map<String, String> rationale, final JSCallback callback) {
    ...
    public void destroy() {
        for (int i = 0; i < callbacks.size(); i++) {
            callbacks.valueAt(i).invoke(new SimplePermissionResult("", false, States.FAILED, "Activity destroyed"));
        }
        callbacks.clear();
    }
